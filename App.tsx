  ...
  return (
    ...
    >
      <header className="h-12 sm:h-14 lg:h-16 shrink-0 sticky top-0 z-20 flex items-center justify-center px-4 sm:px-6 backdrop-blur-sm bg-inherit">
        ...
        {/* Title - centered */}
        <span
          className={`font-bold text-lg sm:text-xl lg:text-2xl tracking-tighter text-center ${theme === "classic" ? "text-wnrs-red" : "text-white"}`}
        >
          THE PRAWN GAME
        </span>
            ...
            >
              ...
              <div className="w-full flex flex-col items-center">
                <div className="text-center mb-4 sm:mb-6 lg:mb-8">
                  ...
                  <p className="opacity-60 text-sm sm:text-base lg:text-lg">
                  ...
                  {cardSets.map((cardSet) => (
                    ...
                    >
                      <div className="flex items-center gap-3 sm:gap-4">
                        <div
                          className={`p-2 sm:p-2.5 lg:p-3 rounded-full transition-colors ${
                            cardSet.enabled
                ...
                <div className="w-full mt-4 sm:mt-6 lg:mt-8">
                  <Button
                    ...
                    className="py-4 sm:py-5 lg:py-6 text-base sm:text-lg lg:text-xl"
                  >
      ...
      <footer className="shrink-0 py-3 sm:py-4 text-center pb-safe">
        <span
          className={`text-[10px] sm:text-xs lg:text-sm font-bold tracking-[0.2em] uppercase ${theme === "classic" ? "text-gray-400" : "text-gray-600"}`}
        >
